...
args.model_prefix = 'bilstm_'+str(args.num_dicts)+"x"+str(args.orddict_emb_num)+'dec'+str(args.dec_nh)+'_suffixd'+str(args.incat)+'/'
...
if dataset_type == 'I':
    ...
    ae_fhs_vectors_fwd = torch.load('model/vqvae/results/fhs/fhs_datasetIV-train_fwd_d512.pt').to('cpu')
