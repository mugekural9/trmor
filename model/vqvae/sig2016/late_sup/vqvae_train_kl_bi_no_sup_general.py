...
from model.vqvae.sig2016.late_sup.vqvae_kl_bi_late_sup_general import VQVAE
...
args.nz = 128; 
args.num_dicts = 2 #len(tag_vocabs)
args.outcat=0; 
...
writer = SummaryWriter("runs/late-sup-general/"+args.lang+'/'+ args.model_prefix)
...
# logging
args.modelname = 'model/'+args.mname+'/results/training/sig2016/'+args.lang+'/late-sup-general/'+str(args.usize)+'_instances/'+args.model_prefix
