...
_model_id = args.lang+'_thesis_sig2016_withux'
...
writer = SummaryWriter("runs/early-supervision-thesis-withux-TEST/"+args.lang+'/'+ args.model_prefix)




# logging
args.modelname = 'model/'+args.mname+'/results/training/sig2016/'+args.lang+'/early-supervision-thesis-withux-TEST/'+str(args.lxtgtsize)+'_instances/'+args.model_prefix
