...
#ae_fhs_vectors_bck = torch.load('model/vqvae/results/fhs/'+args.lang+'_fhs_datasetV-train_all_d360.pt').to('cpu')
...
writer = SummaryWriter("runs/sig2018-early-supervision/"+args.lang+'/'+ args.model_prefix)
