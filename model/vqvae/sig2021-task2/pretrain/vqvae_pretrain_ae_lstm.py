...
def train(data, args):
    ...
    for epc in range(args.epochs):
        ...
        if loss < best_loss:
            ...
            if args.model.encoder.lstm.bidirectional:
                torch.save(epoch_encoder_fhs_fwd, args.lang+'_fhs_'+args.dataset_type+'-train_fwd_d'+str(args.enc_nh)+'.pt')
                torch.save(epoch_encoder_fhs_bck, args.lang+'_fhs_'+args.dataset_type+'-train_bck_d'+str(args.enc_nh)+'.pt')
                torch.save(epoch_encoder_fhs,     args.lang+'_fhs_'+args.dataset_type+'-train_all_d'+str(args.enc_nh*2)+'.pt')
        args.model.train()
...
args.dataset_type = 'sig2021-task2'
args.lang     = 'Turkish'
...
#tensorboard
writer = SummaryWriter("runs/pretraining_ae/sig2021-task2/"+args.lang+'/')


# logging
args.modelname = 'model/'+args.mname+'/results/training/sig2021-task2/'+args.lang+'/unsup/'+str(len(trndata))+'_instances/'
try:
