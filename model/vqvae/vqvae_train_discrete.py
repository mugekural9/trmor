...
if dataset_type == 'I':
    ...
    ae_fhs_vectors_fwd = torch.load('model/vqvae/results/fhs/fhs_datasetIV_rf-train_fwd_d512.pt').to('cpu')
    ae_fhs_vectors_bck = torch.load('model/vqvae/results/fhs/fhs_datasetIV_rf-train_bck_d512.pt').to('cpu')
    _model_id  = 'ae_bilstm_zhou'
elif dataset_type == 'V':
