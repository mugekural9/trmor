...
class VQVAE_Encoder(nn.Module):
    ...
    def forward(self, input):
        ...
        return last_state,  None , mean.squeeze(0), logvar.squeeze(0), fwd,bck
...
class VQVAE_Decoder(nn.Module):
    ...
    def __init__(self, args, vocab, model_init, emb_init):
        ...
        self.gru = nn.GRU(input_size=args.ni + args.incat, # self.char_embed+ self.ni
...
class VQVAE(nn.Module):
    ...
    def vq_loss(self,x, tags, epc, mode):
        ...
        # kl version
        fhs, _, mu, logvar, fwd,bck = self.encoder(x)
    ...
    def loss(self, x: Tensor, tags, kl_weight, epc, mode='train', **kwargs) -> List[Tensor]:
        ...
        # (1, batch_size, dec_nh)
        dec_h0 = torch.tanh(root_z_to_dec)
