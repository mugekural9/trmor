...
from model.vqvae.sig2016.vqvae_kl_bi_early_sup import VQVAE
        ...
        with torch.no_grad():
            ...
            if epc%3==0 or epc>100:
                ...
                if shared_acc > best_shared_task_acc:
                    ...
                    with open( args.modelname+'_SIGMORPHON2021_TRUE.txt', 'w') as writer_true:
                        with open( args.modelname+'_SIGMORPHON2021_FALSE.txt', 'w') as writer_false:
                ...
                if shared_acc_direct > best_shared_task_acc_direct:
                    ...
                    with open( args.modelname+'_SIGMORPHON2021_TRUE_DIRECTS.txt', 'w') as writer_true_directs:
                        with open( args.modelname+'_SIGMORPHON2021_FALSE_DIRECTS.txt', 'w') as writer_false_directs:
...
def oracle(args, reinflected_word, itr=0):
...
_model_id = 'sigmorphon2021_ae_'+args.lang+'_lstm_unsup_'+str(args.enc_nh)
ae_fhs_vectors_bck = torch.load('model/vqvae/results/fhs/SIG2021/'+args.lang+'_fhs_SIGMORPHON2021-LSTM-train_bck_d'+str(args.enc_nh)+'.pt').to('cpu')
ae_fhs_vectors     = torch.load('model/vqvae/results/fhs/SIG2021/'+args.lang+'_fhs_SIGMORPHON2021-LSTM-train_all_d'+str(args.enc_nh*2)+'.pt').to('cpu')
...
# data
if args.lang == 'tur':
    args.trndata  = 'data/sigmorphon2021/surprise_languages/'+args.lang+'.train'
else:
    args.trndata  = 'data/sigmorphon2021/development_languages/'+args.lang+'.train'
args.valdata  = 'data/sigmorphon2021/ground-truth/'+args.lang+'.test'
args.tstdata  = args.valdata
args.unlabeled_data = args.trndata

args.maxtrnsize = 750000; args.maxvalsize = 1000; args.maxtstsize = 1000000000000; args.maxusize= 110000
args.ux_weight = 1.0
args.ux_start_epc = 0

from model.vqvae.data.data_2_sigmorphon2021 import build_data
...
writer = SummaryWriter("runs/sig2021-early-supervision-lstm/"+args.lang+'/'+ args.model_prefix)
...
# logging
args.modelname = 'model/'+args.mname+'/results/training/'+args.lang+'/sig2021/early-supervision-lstm/'+str(args.usize)+'_instances/'+args.model_prefix
