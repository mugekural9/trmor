...
def shared_task_gen_direct(args, tstbatches,epc):
    ...
    with open(args.modelname+'_SIGMORPHON2021_TRUE_DIRECT.txt', 'w') as writer_true:
        with open(args.modelname+'_SIGMORPHON2021_FALSE_DIRECT.txt', 'w') as writer_false:
            ...
            for _, idx in enumerate(indices):
                ...
                fhs, _,  mu, logvar, fwd,bck = args.model.encoder(surf)
        ...
        with open(args.modelname+'_SIGMORPHON2021_FALSE.txt', 'w') as writer_false:
            with open(args.tstdata, 'r') as reader:
                ...
                for line in reader:
                    ...
                    inflected_word, gold_reinflection, asked_tag  = split_line
...
_model_id = 'sigmorphon2021_ae_'+args.lang+'_gru_unsup_' + str(args.enc_nh)
ae_fhs_vectors     = torch.load('model/vqvae/results/fhs/SIG2021/'+args.lang+'_fhs_SIGMORPHON2021-GRU-train_all_d'+str(args.enc_nh*2)+'.pt').to('cpu')
...
writer = SummaryWriter("runs/sig2021-early-supervision-nobias-gru/"+args.lang+'/'+ args.model_prefix)
...
# logging
args.modelname = 'model/'+args.mname+'/results/training/'+args.lang+'/early-supervision-nobias-gru/'+str(args.lxtgtsize)+'_instances/'+args.model_prefix
