...
_model_id = 'sigmorphon2021_ae_'+args.lang+'_unsup_'+str(args.enc_nh)
...
writer = SummaryWriter("runs/sig2021-no-supervision-nobias-testtanh/"+args.lang+'/'+ args.model_prefix)
...
# logging
args.modelname = 'model/'+args.mname+'/results/training/'+args.lang+'/sig2021/no-supervision-nobias-testtanh/'+str(args.usize)+'_instances/'+args.model_prefix
