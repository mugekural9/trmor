...
writer = SummaryWriter("runs/sig2021/no-supervision/"+args.lang+'/'+ args.model_prefix)
...
# logging
args.modelname = 'model/'+args.mname+'/results/training/'+args.lang+'/sig2021/no-supervision/'+str(args.usize)+'_instances/'+args.model_prefix
