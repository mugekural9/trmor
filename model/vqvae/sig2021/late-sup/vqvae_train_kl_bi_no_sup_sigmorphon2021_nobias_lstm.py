...
from model.vqvae.sig2016.vqvae_kl_bi_early_sup_nobias_lstm import VQVAE
...
writer = SummaryWriter("runs/sig2021-no-supervision-nobias-lstm/"+args.lang+'/'+ args.model_prefix)
...
# logging
args.modelname = 'model/'+args.mname+'/results/training/'+args.lang+'/sig2021/no-supervision-nobias-lstm/'+str(args.usize)+'_instances/'+args.model_prefix
