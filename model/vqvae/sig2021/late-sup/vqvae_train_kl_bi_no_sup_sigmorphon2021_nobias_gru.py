...
writer = SummaryWriter("runs/sig2021-no-supervision-nobias-gru/"+args.lang+'/'+ args.model_prefix)
...
# logging
args.modelname = 'model/'+args.mname+'/results/training/'+args.lang+'/sig2021/no-supervision-nobias-gru/'+str(args.usize)+'_instances/'+args.model_prefix
