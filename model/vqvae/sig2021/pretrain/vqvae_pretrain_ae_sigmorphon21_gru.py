    ...
    for epc in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            if loss < best_loss:
                ...
                if args.model.encoder.gru.bidirectional:
                    torch.save(epoch_encoder_fhs_fwd, 'model/vqvae/results/fhs/SIG2021/'+args.lang+'_fhs_SIGMORPHON2021-GRU-train_fwd_d'+str(args.enc_nh)+'.pt')
                    torch.save(epoch_encoder_fhs_bck, 'model/vqvae/results/fhs/SIG2021/'+args.lang+'_fhs_SIGMORPHON2021-GRU-train_bck_d'+str(args.enc_nh)+'.pt')
                    torch.save(epoch_encoder_fhs,     'model/vqvae/results/fhs/SIG2021/'+args.lang+'_fhs_SIGMORPHON2021-GRU-train_all_d'+str(args.enc_nh*2)+'.pt')
...
# logging
args.modelname = 'model/'+args.mname+'/results/training/'+args.lang+'/sig2021/gru/'+str(len(trndata))+'_instances/enc_nh_' + str(args.enc_nh) + '/' 
try:
