...
args.model_prefix = 'kl0.1_'+str(args.num_dicts)+"x"+str(args.orddict_emb_num)+'_dec'+str(args.dec_nh)+'_suffixd'+str(args.incat)+'/'
...
if dataset_type == 'I':
    ...
    #ae_fhs_vectors_fwd = torch.load('model/vqvae/results/fhs/fhs_datasetV-train_d512.pt').to('cpu')
    #ae_fhs_vectors_bck = torch.load('model/vqvae/results/fhs/fhs_datasetV-train_bck_d512.pt').to('cpu')
    _model_id  = 'ae_unilstm_29k_zhou'
