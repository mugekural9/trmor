...
args.device         = 'cuda'
args.mname          = 'ae_probe' 
model_path          = 'evaluation/probing/polarity/results/ae_probe/14000_instances/100epochs.pt'
model_surf_vocab    = 'evaluation/probing/polarity/results/ae_probe/14000_instances/surf_vocab.json'
model_polar_vocab   = 'evaluation/probing/polarity/results/ae_probe/14000_instances/polar_vocab.json'
