...
args.device         = 'cuda'
args.mname          = 'ae_1_probe_32' 
model_path          = 'evaluation/probing/root_concept/results/training/ae_for_vqvae_001_probe/3487_instances/300epochs.pt'
model_surf_vocab    = 'evaluation/probing/root_concept/results/training/ae_for_vqvae_001_probe/3487_instances/surf_vocab.json'
...
with open(root_concept_vocab) as f:
    word2id = json.load(f)
    root_concept_vocab = VocabEntry(word2id)
...
args.nh = args.enc_nh
args.model = AE_Probe(args, root_concept_vocab, model_init, emb_init)
...
def classify(word):
    ...
    #print(word+': '+root_concept_vocab.id2word(pred))
    return pred
