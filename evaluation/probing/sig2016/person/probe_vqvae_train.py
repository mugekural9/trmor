...
# data
args.trndata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/person/hun_per.trn.txt'
args.valdata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/person/hun_per.val.txt'
