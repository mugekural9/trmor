...
_model_path, surf_vocab, tag_vocabs  = get_model_info('hungarian_vqvae_probe') 
# initialize model
...
# data
args.trndata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/case/hun_case.trn.txt'
args.valdata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/case/hun_case.val.txt'
...
#args.tag_vocabs =  args.tag_vocabs[probe_morph_tag]
...
args.nh = args.nz
args.probe = Probe(args, len(args.tag_vocabs[probe_morph_tag]))
args.probe.to(args.device)

# data
#args.trndata  = 'evaluation/probing/sig2016/tense/hun_tense.trn.txt'
#args.valdata  = 'evaluation/probing/sig2016/tense/hun_tense.val.txt'
#args.tstdata  = args.valdata
