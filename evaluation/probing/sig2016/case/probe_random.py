...
args.nh = 660#args.nz
args.probe = Probe(args, len(args.tag_vocabs['case']))
args.probe.to(args.device)

# data
args.trndata  = 'evaluation/probing/sig2016/case/case.trn.txt'
args.valdata  = 'evaluation/probing/sig2016/case/case.val.txt'
args.tstdata  = args.valdata
