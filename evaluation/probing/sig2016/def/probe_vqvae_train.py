...
# data
args.trndata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/def/def.trn.txt'
args.valdata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/def/def.val.txt'
