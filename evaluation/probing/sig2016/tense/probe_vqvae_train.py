...
# data
args.trndata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/tense/hun_tense.trn.txt'
args.valdata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/tense/hun_tense.val.txt'
