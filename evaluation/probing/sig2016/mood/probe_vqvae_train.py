...
# data
args.trndata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/mood/mood.trn.txt'
args.valdata  = '/kuacc/users/mugekural/workfolder/dev/git/trmor/evaluation/probing/sig2016/mood/mood.val.txt'
