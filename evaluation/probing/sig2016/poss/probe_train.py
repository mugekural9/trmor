...
# data
args.trndata  = 'evaluation/probing/sig2016/'+probe_morph_tag+'/'+probe_morph_tag+'.trn.txt'
args.valdata  = 'evaluation/probing/sig2016/'+probe_morph_tag+'/'+probe_morph_tag+'.val.txt'
args.tstdata  = args.valdata
