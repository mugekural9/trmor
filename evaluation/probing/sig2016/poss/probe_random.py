...
args.nh = 660#args.nz
args.probe = Probe(args, len(args.tag_vocabs['poss']))
args.probe.to(args.device)

# data
args.trndata  = 'evaluation/probing/sig2016/poss/poss.trn.txt'
args.valdata  = 'evaluation/probing/sig2016/poss/poss.val.txt'
args.tstdata  = args.valdata
