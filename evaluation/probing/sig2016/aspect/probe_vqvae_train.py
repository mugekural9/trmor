...
rawdata, batches, _, tag_vocabs = build_data(args, args.surf_vocab, args.tag_vocabs)
...
if probe_part == 'quantized':
    args.nh = args.enc_nh
args.probe = Probe(args, len(tag_vocabs[probe_morph_tag]))
args.probe.to(args.device)

# data
args.trndata  = 'evaluation/probing/sig2016/aspect/aspect.trn.txt'
args.valdata  = 'evaluation/probing/sig2016/aspect/aspect.val.txt'
args.tstdata  = args.valdata
