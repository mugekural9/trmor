...
args.nh = 660#args.nz
args.probe = Probe(args, len(args.tag_vocabs['num']))
args.probe.to(args.device)

# data
args.trndata  = 'evaluation/probing/sig2016/num/num.trn.txt'
args.valdata  = 'evaluation/probing/sig2016/num/num.val.txt'
args.tstdata  = args.valdata
