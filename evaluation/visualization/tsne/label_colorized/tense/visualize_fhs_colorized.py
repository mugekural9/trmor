...
# Date:        2022/02/19 
# Author:      Muge Kural
# Description: Visualizations of final hidden states (points) of trained model with t-SNE and colorizes a point based on its tense label 
# -----------------------------------------------------------
...
def config():
    ...
    probe_id = 'charlm_4_probe_tense'
    _, (_, tense_vocab)  = get_model_info(probe_id) 

    # logging
    args.logdir = 'evaluation/visualization/tsne/label_colorized/tense/results/'+model_id+'/'
    ...
    args.model.eval()
    # data
    args.tstdata = 'evaluation/visualization/tsne/label_colorized/tense/data/surf.uniquesurfs.trn.txt'
